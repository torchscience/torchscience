...
// ============================================================================
// Sparse COO CUDA operators delegate to dense operations on values
// Same structure as CPU version but registers to SparseCUDA dispatch key
// ============================================================================
...
// ============================================================================
// SparseCooCudaUnaryOperator
// ============================================================================

struct SparseCooCudaUnaryOperator {
...
#define REGISTER_SPARSE_COO_CUDA_UNARY(module, name) \
    ::torchscience::sparse::coo::cuda::SparseCooCudaUnaryOperator::register_all( \
...
// ============================================================================
// SparseCooCudaBinaryOperator
// ============================================================================

struct SparseCooCudaBinaryOperator {
    static at::Tensor forward(
...
#define REGISTER_SPARSE_COO_CUDA_BINARY(module, name) \
    ::torchscience::sparse::coo::cuda::SparseCooCudaBinaryOperator::register_all( \
        module, #name, #name "_backward", #name "_backward_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward", \
        "torchscience::" #name "_backward_backward")
...
// ============================================================================
// SparseCooCudaTernaryOperator
// ============================================================================

struct SparseCooCudaTernaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
...
#define REGISTER_SPARSE_COO_CUDA_TERNARY(module, name) \
    ::torchscience::sparse::coo::cuda::SparseCooCudaTernaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")

// ============================================================================
// SparseCooCudaQuaternaryOperator
// ============================================================================

struct SparseCooCudaQuaternaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
...
#define REGISTER_SPARSE_COO_CUDA_QUATERNARY(module, name) \
    ::torchscience::sparse::coo::cuda::SparseCooCudaQuaternaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")

// ============================================================================
// SparseCooCudaQuinaryOperator
// ============================================================================

struct SparseCooCudaQuinaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
        ...
        TORCH_CHECK(
            input1.is_sparse() && input2.is_sparse() &&
            input3.is_sparse() && input4.is_sparse() && input5.is_sparse(),
            "expects sparse COO tensors"
        );
    ...
    static std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> backward(
        ...
        auto [new_grad1, new_grad2, new_grad3, new_grad4, new_grad5] =
            ...
            .call(grad_output._values(), input1._values(), input2._values(),
                  input3._values(), input4._values(), input5._values());
        ...
        if (new_grad5.defined()) {
            grad5 = detail::make_sparse_coo(
                input5._indices(), new_grad5, input5.sizes(),
                input5.options(), input5.is_coalesced()
            );
        }
...
#define REGISTER_SPARSE_COO_CUDA_QUINARY(module, name) \
    ::torchscience::sparse::coo::cuda::SparseCooCudaQuinaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")
