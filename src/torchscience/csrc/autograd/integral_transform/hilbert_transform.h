...
/**
 * Backward function class for Hilbert transform double-backward support.
 */
class HilbertTransformBackward
    : public torch::autograd::Function<HilbertTransformBackward> {
public:
...
/**
 * Forward function class for Hilbert transform with autograd support.
 */
class HilbertTransform
    : public torch::autograd::Function<HilbertTransform> {
public:
    ...
    static torch::autograd::variable_list backward(
        ...
        std::vector<at::Tensor> gradients = HilbertTransformBackward::apply(
            grad_output,
            input,
            n,
            dim,
...
inline at::Tensor hilbert_transform(
    ...
    return HilbertTransform::apply(input, n, dim, padding_mode, padding_value, window);
}
...
TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl(
        "hilbert_transform",
        &torchscience::autograd::integral_transform::hilbert_transform
    );
}
