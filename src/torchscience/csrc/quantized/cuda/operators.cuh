...
// ============================================================================
// Quantized CUDA operators dequantize, delegate to dense ops, then requantize
// Same structure as CPU version but registers to QuantizedCUDA dispatch key
// ============================================================================
...
// ============================================================================
// QuantizedCudaUnaryOperator
// ============================================================================

struct QuantizedCudaUnaryOperator {
...
#define REGISTER_QUANTIZED_CUDA_UNARY(module, name) \
    ::torchscience::quantized::cuda::QuantizedCudaUnaryOperator::register_all( \
...
// ============================================================================
// QuantizedCudaBinaryOperator
// ============================================================================

struct QuantizedCudaBinaryOperator {
    static at::Tensor forward(
...
#define REGISTER_QUANTIZED_CUDA_BINARY(module, name) \
    ::torchscience::quantized::cuda::QuantizedCudaBinaryOperator::register_all( \
        module, #name, #name "_backward", #name "_backward_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward", \
        "torchscience::" #name "_backward_backward")
...
// ============================================================================
// QuantizedCudaTernaryOperator
// ============================================================================

struct QuantizedCudaTernaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
...
#define REGISTER_QUANTIZED_CUDA_TERNARY(module, name) \
    ::torchscience::quantized::cuda::QuantizedCudaTernaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")

// ============================================================================
// QuantizedCudaQuaternaryOperator
// ============================================================================

struct QuantizedCudaQuaternaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
...
#define REGISTER_QUANTIZED_CUDA_QUATERNARY(module, name) \
    ::torchscience::quantized::cuda::QuantizedCudaQuaternaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")

// ============================================================================
// QuantizedCudaQuinaryOperator
// ============================================================================

struct QuantizedCudaQuinaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
...
#define REGISTER_QUANTIZED_CUDA_QUINARY(module, name) \
    ::torchscience::quantized::cuda::QuantizedCudaQuinaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")
