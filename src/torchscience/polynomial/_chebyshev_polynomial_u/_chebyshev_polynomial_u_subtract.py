...
def chebyshev_polynomial_u_subtract(
    a: ChebyshevPolynomialU,
    b: ChebyshevPolynomialU,
) -> ChebyshevPolynomialU:
    """Subtract two Chebyshev U series.
    ...
    Examples
    --------
    >>> a = chebyshev_polynomial_u(torch.tensor([5.0, 7.0, 9.0]))
    >>> b = chebyshev_polynomial_u(torch.tensor([1.0, 2.0, 3.0]))
    >>> c = chebyshev_polynomial_u_subtract(a, b)
    >>> c.coeffs
    tensor([4., 5., 6.])
    """
    a_coeffs = a.coeffs
