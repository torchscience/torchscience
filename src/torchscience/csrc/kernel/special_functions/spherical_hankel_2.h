...
template <typename T>
constexpr T spherical_hankel_2_eps();

template <>
constexpr float spherical_hankel_2_eps<float>() { return 1e-6f; }

template <>
constexpr double spherical_hankel_2_eps<double>() { return 1e-12; }

template <>
inline c10::Half spherical_hankel_2_eps<c10::Half>() { return c10::Half(1e-3f); }

template <>
inline c10::BFloat16 spherical_hankel_2_eps<c10::BFloat16>() { return c10::BFloat16(1e-3f); }
...
template <typename T>
c10::complex<T> spherical_hankel_2(c10::complex<T> n, c10::complex<T> z) {
