...
template <typename T>
std::tuple<T, T> cosh_pi_backward_backward(T gg, T g, T x) {
  ...
  T gg_output = gg * pi * sinh_pi_x;
  T g_x = gg * g * pi * pi * cosh_pi_x;
...
std::tuple<c10::complex<T>, c10::complex<T>> cosh_pi_backward_backward(
  ...
  c10::complex<T> gg_output = gg * pi * sinh_pi_z;
  c10::complex<T> g_z = gg * g * pi * pi * cosh_pi_z;
