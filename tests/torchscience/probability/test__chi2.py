...
class TestChi2Pdf:
    """Test chi2_pdf forward correctness."""
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.chi2_pdf(x, df)
        expected = torch.tensor(
    ...
    def test_various_df(self, df):
        ...
        result = torch.ops.torchscience.chi2_pdf(x, df_t)
        expected = torch.tensor(
...
class TestChi2Ppf:
    """Test chi2_ppf forward correctness."""
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.chi2_ppf(p, df)
        expected = torch.tensor(
    ...
    def test_inverse_of_cdf(self):
        ...
        x = torch.ops.torchscience.chi2_ppf(p, df)
        p_recovered = torch.ops.torchscience.chi2_cdf(x, df)
    ...
    def test_various_df(self, df):
        ...
        result = torch.ops.torchscience.chi2_ppf(p, df_t)
        expected = torch.tensor(
...
class TestChi2Sf:
    """Test chi2_sf forward correctness."""
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.chi2_sf(x, df)
        expected = torch.tensor(
    ...
    def test_cdf_plus_sf_equals_one(self):
        ...
        cdf = torch.ops.torchscience.chi2_cdf(x, df)
        sf = torch.ops.torchscience.chi2_sf(x, df)
