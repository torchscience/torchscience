    ...
    AT_DISPATCH_FLOATING_TYPES_AND2(
        ...
        [&]() {
            ...
            if (range.has_value() && range->size() == 2) {
                ...
                bool valid = impl::descriptive::compute_data_range<compute_t>(
            ...
            compute_t total = impl::descriptive::histogram_1d<compute_t>(
                data_ptr,
                n,
                counts_ptr,
                edges_ptr,
            ...
            if (density) {
                compute_t bin_width = impl::descriptive::compute_bin_width<compute_t>(
...
inline std::tuple<at::Tensor, at::Tensor> histogram_edges(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND2(
        ...
        [&]() {
            ...
            if (density) {
                impl::descriptive::normalize_density_variable_width<compute_t>(
