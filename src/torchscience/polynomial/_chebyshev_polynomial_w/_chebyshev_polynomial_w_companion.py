...
def chebyshev_polynomial_w_companion(
    c: ChebyshevPolynomialW,
) -> Tensor:
    """Generate companion matrix for Chebyshev W series.
    ...
    ----------
    c : ChebyshevPolynomialW
        Chebyshev W series. Must be monic (leading coefficient 1) or
        will be normalized.
    ...
    Notes
    -----
    The Chebyshev W companion matrix is constructed similarly to other
    Chebyshev companion matrices, as a symmetric tridiagonal matrix
    that is similar to the Jacobi matrix for Chebyshev W polynomials.
    ...
    # The Chebyshev W companion matrix is symmetric tridiagonal
