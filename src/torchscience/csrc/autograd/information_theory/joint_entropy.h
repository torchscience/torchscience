...
class JointEntropyBackward
    : public torch::autograd::Function<JointEntropyBackward> {
public:
    static at::Tensor forward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::joint_entropy_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                at::IntArrayRef,
    ...
    static torch::autograd::variable_list backward(
        ...
        auto [grad_grad_output, grad_joint] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::joint_entropy_backward_backward", "")
...
class JointEntropyFunction
    : public torch::autograd::Function<JointEntropyFunction> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& joint,
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::joint_entropy", "")
            .typed<at::Tensor(
                const at::Tensor&,
                at::IntArrayRef,
                const std::string&,
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = JointEntropyBackward::apply(
            grad_output,
            joint,
            dims,
            input_type,
...
inline at::Tensor joint_entropy(
    ...
    return JointEntropyFunction::apply(joint, dims_vec, input_type, reduction, base);
}

}  // namespace torchscience::autograd::information_theory

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("joint_entropy", &torchscience::autograd::information_theory::joint_entropy);
}
