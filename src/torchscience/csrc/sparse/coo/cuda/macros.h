...
#define SPARSE_COO_CUDA_UNARY_OPERATOR(                                         \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1                                                                          \
)                                                                               \
                                                                                \
namespace torchscience::sparse::coo::cuda::NAMESPACE {                          \
                                                                                \
...
TORCH_LIBRARY_IMPL(torchscience, SparseCUDA, module) {                          \
  module.impl(                                                                  \
    #OPERATOR_NAME,                                                             \
    &torchscience::sparse::coo::cuda::NAMESPACE::OPERATOR_NAME                  \
  );                                                                            \
                                                                                \
  module.impl(                                                                  \
    #OPERATOR_NAME "_backward",                                                 \
    &torchscience::sparse::coo::cuda::NAMESPACE::OPERATOR_NAME##_backward       \
  );                                                                            \
                                                                                \
  module.impl(                                                                  \
    #OPERATOR_NAME "_backward_backward",                                        \
    &torchscience::sparse::coo::cuda::NAMESPACE::OPERATOR_NAME##_backward_backward\
  );                                                                            \
}

#define SPARSE_COO_CUDA_BINARY_OPERATOR(                                        \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2                                                                          \
...
#define SPARSE_COO_CUDA_TERNARY_OPERATOR(                                       \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
...
#define SPARSE_COO_CUDA_QUATERNARY_OPERATOR(                                    \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
