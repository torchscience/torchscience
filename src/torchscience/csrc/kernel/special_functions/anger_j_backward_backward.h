...
template <typename T>
C10_HOST_DEVICE T anger_j_second_derivative_n2(T n, T z) {
...
template <typename T>
C10_HOST_DEVICE T anger_j_second_derivative_nz(T n, T z) {
    const T pi = T(3.14159265358979323846);
...
template <typename T>
C10_HOST_DEVICE std::tuple<T, T, T> anger_j_backward_backward(
    T gg_n,
    T gg_z,
    T grad_output,
    T n,
...
// Complex version
template <typename T>
C10_HOST_DEVICE std::tuple<c10::complex<T>, c10::complex<T>, c10::complex<T>> anger_j_backward_backward(
    c10::complex<T> gg_n,
    c10::complex<T> gg_z,
