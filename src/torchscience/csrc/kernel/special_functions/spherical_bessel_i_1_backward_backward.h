...
template <typename T>
C10_HOST_DEVICE std::tuple<T, T> spherical_bessel_i_1_backward_backward(T gg_z, T grad_output, T z) {
...
// Complex version
template <typename T>
C10_HOST_DEVICE std::tuple<c10::complex<T>, c10::complex<T>> spherical_bessel_i_1_backward_backward(
