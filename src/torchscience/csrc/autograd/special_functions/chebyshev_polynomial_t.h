...
class ChebyshevPolynomialTBackward : public torch::autograd::Function<ChebyshevPolynomialTBackward> {
public:
    ...
    static std::vector<at::Tensor> backward(
        ...
        at::AutoDispatchBelowAutograd guard;
        at::Tensor gg_x = grad_outputs[0].defined() ? grad_outputs[0] : at::Tensor();
        at::Tensor gg_n = grad_outputs[1].defined() ? grad_outputs[1] : at::Tensor();
        ...
        auto [gg_out, new_grad_x, new_grad_n] = op.call(gg_x, gg_n, saved[0], saved[1], saved[2]);
        return {gg_out, new_grad_x, new_grad_n, at::Tensor()};
    }
};

class ChebyshevPolynomialTForward : public torch::autograd::Function<ChebyshevPolynomialTForward> {
public:
    ...
    static torch::autograd::variable_list backward(
        ...
        auto saved = ctx->get_saved_variables();
        bool x_requires_grad = ctx->saved_data["x_requires_grad"].toBool();
        auto grads = ChebyshevPolynomialTBackward::apply(grad_outputs[0], saved[0], saved[1], x_requires_grad);
