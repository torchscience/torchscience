...
// ============================================================================
// SparseCooCpuQuinaryOperator
// ============================================================================

struct SparseCooCpuQuinaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
...
#define REGISTER_SPARSE_COO_CPU_QUINARY(module, name) \
    ::torchscience::sparse::coo::cpu::SparseCooCpuQuinaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")
