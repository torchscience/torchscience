...
def chebyshev_polynomial_u_equal(
    a: ChebyshevPolynomialU,
    b: ChebyshevPolynomialU,
    tol: float = 0.0,
) -> bool:
    """Check if two Chebyshev U series are equal.
    ...
    >>> b = chebyshev_polynomial_u(torch.tensor([1.0, 2.0, 0.0]))
    >>> chebyshev_polynomial_u_equal(a, b)
    True
    """
    a_coeffs = a.coeffs
    b_coeffs = b.coeffs
