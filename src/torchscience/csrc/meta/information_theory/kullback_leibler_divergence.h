...
/**
 * Meta implementation for KL divergence shape inference.
 *
...
inline at::Tensor kullback_leibler_divergence(
    ...
    if (pairwise) {
        ...
        TORCH_CHECK(
            p.dim() == 2 && q.dim() == 2,
            "kullback_leibler_divergence: pairwise mode requires 2D tensors"
        );
...
/**
 * Meta implementation for KL divergence backward shape inference.
 *
...
/**
 * Meta implementation for KL divergence backward backward shape inference.
 *
