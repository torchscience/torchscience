...
template <typename T>
std::tuple<T, T> tanh_pi_backward_backward(T gradient_gradient, T g, T x) {
  ...
  return std::make_tuple(
    ...
    -gradient_gradient * g * T(2) * pi * pi * tanh_pi_x * sech2_pi_x
  );
}
...
std::tuple<c10::complex<T>, c10::complex<T>> tanh_pi_backward_backward(
  ...
  return std::make_tuple(
    ...
    -gradient_gradient * g * T(2) * pi * pi * tanh_pi_z * sech2_pi_z
  );
}
