...
// ============================================================================
// Sparse CSR CPU operators delegate to dense operations on values
// ============================================================================
...
// ============================================================================
// SparseCsrCpuUnaryOperator
// ============================================================================

struct SparseCsrCpuUnaryOperator {
...
#define REGISTER_SPARSE_CSR_CPU_UNARY(module, name) \
    ::torchscience::sparse::csr::cpu::SparseCsrCpuUnaryOperator::register_all( \
...
// ============================================================================
// SparseCsrCpuBinaryOperator
// ============================================================================

struct SparseCsrCpuBinaryOperator {
    static at::Tensor forward(
...
#define REGISTER_SPARSE_CSR_CPU_BINARY(module, name) \
    ::torchscience::sparse::csr::cpu::SparseCsrCpuBinaryOperator::register_all( \
        module, #name, #name "_backward", #name "_backward_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward", \
        "torchscience::" #name "_backward_backward")
...
// ============================================================================
// SparseCsrCpuTernaryOperator
// ============================================================================

struct SparseCsrCpuTernaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
...
#define REGISTER_SPARSE_CSR_CPU_TERNARY(module, name) \
    ::torchscience::sparse::csr::cpu::SparseCsrCpuTernaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")

// ============================================================================
// SparseCsrCpuQuaternaryOperator
// ============================================================================

struct SparseCsrCpuQuaternaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
...
#define REGISTER_SPARSE_CSR_CPU_QUATERNARY(module, name) \
    ::torchscience::sparse::csr::cpu::SparseCsrCpuQuaternaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")

// ============================================================================
// SparseCsrCpuQuinaryOperator
// ============================================================================

struct SparseCsrCpuQuinaryOperator {
    static at::Tensor forward(
        const at::Tensor& input1,
        const at::Tensor& input2,
        const at::Tensor& input3,
...
#define REGISTER_SPARSE_CSR_CPU_QUINARY(module, name) \
    ::torchscience::sparse::csr::cpu::SparseCsrCpuQuinaryOperator::register_all( \
        module, #name, #name "_backward", \
        "torchscience::" #name, \
        "torchscience::" #name "_backward")
