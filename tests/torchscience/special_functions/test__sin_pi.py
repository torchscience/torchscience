...
class TestSinPi(OpTestCase):
    @property
    def descriptor(self) -> OperatorDescriptor:
        return OperatorDescriptor(
            name="sin_pi",
            func=torchscience.special_functions.sin_pi,
            arity=1,
            input_specs=[
                InputSpec(
                    name="x",
            ...
            sympy_func=lambda x: sympy.sin(sympy.pi * x),
    ...
    def test_gradcheck(self):
        ...
        torch.autograd.gradcheck(
            torchscience.special_functions.sin_pi,
            (x,),
            eps=1e-5,
            atol=1e-3,
            rtol=1e-3,
