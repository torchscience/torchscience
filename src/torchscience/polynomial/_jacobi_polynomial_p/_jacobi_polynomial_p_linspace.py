...
def jacobi_polynomial_p_linspace(
    n: int,
    ...
    """Generate n evenly spaced points in the Jacobi domain.
    ...
    Notes
    -----
    The default domain [-1, 1] is the natural domain for Jacobi polynomials.
    For non-uniform sampling optimal for integration, use
    jacobi_polynomial_p_points instead.

    Examples
    --------
    >>> jacobi_polynomial_p_linspace(5)
    tensor([-1.0000, -0.5000,  0.0000,  0.5000,  1.0000])

    >>> jacobi_polynomial_p_linspace(3, start=0.0, end=1.0)
