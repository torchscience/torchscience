...
// Backward pass for inverse Jacobi elliptic function arcdn(x, m)
//
// Analytical derivatives:
// d(arcdn)/dx = -1 / (sqrt(m) * sqrt((1 - x^2)(x^2 - 1 + m) / m))
//             = -1 / sqrt((1 - x^2)(x^2 - 1 + m))
// d(arcdn)/dm involves more complex expressions with elliptic integrals
//
