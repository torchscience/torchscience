...
#define QUANTIZED_CPU_UNARY_OPERATOR(                                           \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1                                                                          \
)                                                                               \
...
TORCH_LIBRARY_IMPL(torchscience, QuantizedCPU, module) {                        \
  ...
  module.impl(                                                                  \
    ...
    &torchscience::quantized::cpu::NAMESPACE::OPERATOR_NAME##_backward          \
  );                                                                            \
                                                                                \
  module.impl(                                                                  \
    #OPERATOR_NAME "_backward_backward",                                        \
    &torchscience::quantized::cpu::NAMESPACE::OPERATOR_NAME##_backward_backward \
  );                                                                            \
}

#define QUANTIZED_CPU_BINARY_OPERATOR(                                          \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2                                                                          \
...
#define QUANTIZED_CPU_TERNARY_OPERATOR(                                         \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
...
#define QUANTIZED_CPU_QUATERNARY_OPERATOR(                                      \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
