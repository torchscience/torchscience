...
class TestFCdfForward:
    """Test f_cdf forward correctness."""
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.f_cdf(x, dfn, dfd)
    ...
    def test_symmetric_case(self):
        ...
        result = torch.ops.torchscience.f_cdf(x, d, d)
    ...
    def test_various_df(self, dfn, dfd):
        ...
        result = torch.ops.torchscience.f_cdf(x, dfn_t, dfd_t)
        expected = torch.tensor(
...
class TestFCdfGradients:
    ...
    def test_gradcheck_x(self):
        ...
        def fn(x_):
            return torch.ops.torchscience.f_cdf(x_, dfn, dfd)
    ...
    def test_gradcheck_dfn(self):
        ...
        def fn(dfn_):
            return torch.ops.torchscience.f_cdf(x, dfn_, dfd)
    ...
    def test_gradcheck_dfd(self):
        ...
        def fn(dfd_):
            return torch.ops.torchscience.f_cdf(x, dfn, dfd_)

        assert torch.autograd.gradcheck(fn, (dfd,), eps=1e-6, atol=1e-4)


class TestFPdf:
    """Test f_pdf forward correctness."""
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.f_pdf(x, dfn, dfd)
        expected = torch.tensor(
    ...
    def test_various_df(self, dfn, dfd):
        ...
        result = torch.ops.torchscience.f_pdf(x, dfn_t, dfd_t)
        expected = torch.tensor(
...
class TestFPpf:
    """Test f_ppf forward correctness."""
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.f_ppf(p, dfn, dfd)
        expected = torch.tensor(
    ...
    def test_inverse_of_cdf(self):
        ...
        x = torch.ops.torchscience.f_ppf(p, dfn, dfd)
        p_recovered = torch.ops.torchscience.f_cdf(x, dfn, dfd)
    ...
    def test_various_df(self, dfn, dfd):
        ...
        result = torch.ops.torchscience.f_ppf(p, dfn_t, dfd_t)
        expected = torch.tensor(
...
class TestFSf:
    ...
    def test_scipy_comparison(self):
        ...
        result = torch.ops.torchscience.f_sf(x, dfn, dfd)
        expected = torch.tensor(
    ...
    def test_cdf_plus_sf_equals_one(self):
        ...
        cdf = torch.ops.torchscience.f_cdf(x, dfn, dfd)
        sf = torch.ops.torchscience.f_sf(x, dfn, dfd)
