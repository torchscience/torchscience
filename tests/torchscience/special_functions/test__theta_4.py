...
class TestTheta4:
    ...
    def test_forward_even_symmetry(self):
        ...
        result_pos = torchscience.special_functions.theta_4(z, q)
        result_neg = torchscience.special_functions.theta_4(-z, q)
    ...
    def test_forward_against_mpmath(self):
        ...
        for z_val, q_val in test_cases:
            ...
            result = torchscience.special_functions.theta_4(z, q)
            expected = mpmath_jtheta(4, z_val, q_val)
            torch.testing.assert_close(
                result,
    ...
    def test_gradient(self):
        ...
        assert torch.autograd.gradcheck(
            torchscience.special_functions.theta_4,
            (z, q),
            eps=1e-5,
            atol=1e-3,
            rtol=1e-3,
