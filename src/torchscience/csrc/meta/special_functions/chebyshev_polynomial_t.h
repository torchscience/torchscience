...
TORCH_LIBRARY_IMPL(torchscience, Meta, m) {
    m.impl("chebyshev_polynomial_t", torchscience::meta::chebyshev_polynomial_t_forward);
    m.impl("chebyshev_polynomial_t_backward", torchscience::meta::chebyshev_polynomial_t_backward);
    m.impl("chebyshev_polynomial_t_backward_backward", torchscience::meta::chebyshev_polynomial_t_backward_backward);
}
