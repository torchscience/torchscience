...
/**
 * Sparse CSR CPU implementation of Hilbert transform.
 */
inline at::Tensor hilbert_transform(
    ...
    TORCH_CHECK(
        ...
        "hilbert_transform (SparseCsrCPU) expects sparse CSR tensor"
    );
...
/**
 * Backward pass for sparse CSR CPU Hilbert transform.
 */
inline at::Tensor hilbert_transform_backward(
    ...
    TORCH_CHECK(
        input.layout() == at::kSparseCsr,
        "hilbert_transform_backward (SparseCsrCPU) expects sparse CSR tensor for input"
    );
...
/**
 * Double backward pass for sparse CSR CPU Hilbert transform.
 */
...
TORCH_LIBRARY_IMPL(torchscience, SparseCsrCPU, module) {
    module.impl(
        "hilbert_transform",
        &torchscience::sparse::csr::cpu::integral_transform::hilbert_transform
    );
    module.impl(
        "hilbert_transform_backward",
        &torchscience::sparse::csr::cpu::integral_transform::hilbert_transform_backward
    );
    module.impl(
        "hilbert_transform_backward_backward",
        &torchscience::sparse::csr::cpu::integral_transform::hilbert_transform_backward_backward
    );
}
