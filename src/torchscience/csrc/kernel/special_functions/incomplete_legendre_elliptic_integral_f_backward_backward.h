...
#include "incomplete_legendre_elliptic_integral_f_backward.h"

namespace torchscience::kernel::special_functions {

// Second-order backward pass for incomplete elliptic integral of the first kind F(phi, m)
//
// Uses numerical finite differences for second derivatives.
// Returns gradients w.r.t. (grad_output, phi, m)

template <typename T>
C10_HOST_DEVICE std::tuple<T, T, T> incomplete_legendre_elliptic_integral_f_backward_backward(
    T grad_grad_phi,
    T grad_grad_m,
    T gradient,
    T phi,
    ...
    T f_center = incomplete_legendre_elliptic_integral_f(phi, m);
    ...
    T f_phi_plus_m_plus = incomplete_legendre_elliptic_integral_f(phi + h, m + h);
    T f_phi_plus_m_minus = incomplete_legendre_elliptic_integral_f(phi + h, m - h);
    T f_phi_minus_m_plus = incomplete_legendre_elliptic_integral_f(phi - h, m + h);
    T f_phi_minus_m_minus = incomplete_legendre_elliptic_integral_f(phi - h, m - h);
...
incomplete_legendre_elliptic_integral_f_backward_backward(
    ...
    c10::complex<T> f_center = incomplete_legendre_elliptic_integral_f(phi, m);
    ...
    // For mixed and second partials
    c10::complex<T> f_phi_plus_m_plus = incomplete_legendre_elliptic_integral_f(phi + h_complex, m + h_complex);
    c10::complex<T> f_phi_plus_m_minus = incomplete_legendre_elliptic_integral_f(phi + h_complex, m - h_complex);
    c10::complex<T> f_phi_minus_m_plus = incomplete_legendre_elliptic_integral_f(phi - h_complex, m + h_complex);
    c10::complex<T> f_phi_minus_m_minus = incomplete_legendre_elliptic_integral_f(phi - h_complex, m - h_complex);
