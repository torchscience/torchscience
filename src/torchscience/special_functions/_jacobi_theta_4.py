...
__all__ = ["jacobi_theta_4"]


def jacobi_theta_4(z: Tensor, q: Tensor) -> Tensor:
    r"""
    Jacobi theta function :math:`\theta_4(z, q)`.
    ...
    """
    return torchscience.ops.torchscience._jacobi_theta_4(z, q)
