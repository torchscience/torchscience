...
class MutualInformationBackward
    : public torch::autograd::Function<MutualInformationBackward> {
public:
    static at::Tensor forward(
        ...
        at::Tensor grad_joint = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::mutual_information_backward", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                at::IntArrayRef,
            ...
            .call(grad_output, joint, dims, input_type, reduction, base);
    ...
    static torch::autograd::variable_list backward(
        ...
        auto [grad_grad_output, grad_joint] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::mutual_information_backward_backward", "")
            ...
            .call(gg_joint, grad_output, joint, dims, input_type, reduction, base);
...
class MutualInformationFunction
    : public torch::autograd::Function<MutualInformationFunction> {
public:
    static at::Tensor forward(
        torch::autograd::AutogradContext* ctx,
        const at::Tensor& joint,
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::mutual_information", "")
            .typed<at::Tensor(
                const at::Tensor&,
                at::IntArrayRef,
                const std::string&,
            ...
            .call(joint, dims, input_type, reduction, base);
    ...
    static torch::autograd::variable_list backward(
        ...
        at::Tensor grad_joint = MutualInformationBackward::apply(
            grad_output,
            joint,
            dims,
            input_type,
...
inline at::Tensor mutual_information(
    ...
    return MutualInformationFunction::apply(joint, dims_vec, input_type, reduction, base);
}

}  // namespace torchscience::autograd::information_theory

TORCH_LIBRARY_IMPL(torchscience, Autograd, m) {
    m.impl("mutual_information", &torchscience::autograd::information_theory::mutual_information);
}
