...
#include "jacobi_elliptic_sn_backward.h"

namespace torchscience::kernel::special_functions {

// Second-order backward pass for Jacobi elliptic function sn(u, m)
//
...
std::tuple<T, T, T> jacobi_elliptic_sn_backward_backward(
    ...
    T f_center = jacobi_elliptic_sn(u, m);
    T f_u_plus = jacobi_elliptic_sn(u + h, m);
    T f_u_minus = jacobi_elliptic_sn(u - h, m);
    T f_m_plus = jacobi_elliptic_sn(u, m + h);
    T f_m_minus = jacobi_elliptic_sn(u, m - h);

    // For mixed and second partials
    T f_u_plus_m_plus = jacobi_elliptic_sn(u + h, m + h);
    T f_u_plus_m_minus = jacobi_elliptic_sn(u + h, m - h);
    T f_u_minus_m_plus = jacobi_elliptic_sn(u - h, m + h);
    T f_u_minus_m_minus = jacobi_elliptic_sn(u - h, m - h);
...
jacobi_elliptic_sn_backward_backward(
    ...
    c10::complex<T> f_center = jacobi_elliptic_sn(u, m);
    ...
    // For mixed and second partials
    c10::complex<T> f_u_plus_m_plus = jacobi_elliptic_sn(u + h_complex, m + h_complex);
    c10::complex<T> f_u_plus_m_minus = jacobi_elliptic_sn(u + h_complex, m - h_complex);
    c10::complex<T> f_u_minus_m_plus = jacobi_elliptic_sn(u - h_complex, m + h_complex);
    c10::complex<T> f_u_minus_m_minus = jacobi_elliptic_sn(u - h_complex, m - h_complex);
