...
TORCH_LIBRARY_FRAGMENT(torchscience, module) {
  ...
  module.def("_error_erf(Tensor input) -> Tensor");
  module.def("_error_erf_backward(Tensor grad_output, Tensor input) -> Tensor");
  module.def("_error_erfc(Tensor input) -> Tensor");
  module.def("_error_erfc_backward(Tensor grad_output, Tensor input) -> Tensor");
  ...
  module.def("_error_inverse_erf(Tensor input) -> Tensor");
  module.def("_error_inverse_erf_backward(Tensor grad_output, Tensor input) -> Tensor");
  module.def("_error_inverse_erfc(Tensor input) -> Tensor");
  module.def("_error_inverse_erfc_backward(Tensor grad_output, Tensor input) -> Tensor");
