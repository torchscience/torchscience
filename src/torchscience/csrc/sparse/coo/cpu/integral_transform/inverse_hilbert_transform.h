...
/**
 * Sparse COO CPU implementation of inverse Hilbert transform.
 */
inline at::Tensor inverse_hilbert_transform(
    ...
    TORCH_CHECK(
        input.is_sparse(),
        "inverse_hilbert_transform (SparseCPU) expects sparse COO tensor"
    );
...
/**
 * Backward pass for sparse COO inverse Hilbert transform.
 */
inline at::Tensor inverse_hilbert_transform_backward(
    ...
    TORCH_CHECK(
        input.is_sparse(),
        "inverse_hilbert_transform_backward (SparseCPU) expects sparse COO tensor for input"
    );
...
/**
 * Double backward pass for sparse COO inverse Hilbert transform.
 */
...
TORCH_LIBRARY_IMPL(torchscience, SparseCPU, module) {
    module.impl(
        ...
        &torchscience::sparse::coo::cpu::integral_transform::inverse_hilbert_transform
    );
    module.impl(
        "inverse_hilbert_transform_backward",
        &torchscience::sparse::coo::cpu::integral_transform::inverse_hilbert_transform_backward
    );
    module.impl(
        "inverse_hilbert_transform_backward_backward",
        &torchscience::sparse::coo::cpu::integral_transform::inverse_hilbert_transform_backward_backward
    );
}
