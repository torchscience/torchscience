...
def chebyshev_polynomial_v_add(
    ...
    >>> b = chebyshev_polynomial_v(torch.tensor([3.0, 4.0, 5.0]))
    >>> c = chebyshev_polynomial_v_add(a, b)
    >>> c.coeffs
    tensor([4., 6., 5.])
    """
    a_coeffs = a.coeffs
    ...
    if n_a == n_b:
        return ChebyshevPolynomialV(coeffs=a_coeffs + b_coeffs)
