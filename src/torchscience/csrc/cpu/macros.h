    ...
    [&]() {                                                                     \
      at::native::cpu_kernel_multiple_outputs(                                  \
        ...
        [                                                                       \
          ...
          scalar_t                                                              \
        > {                                                                     \
          return impl::NAMESPACE::OPERATOR_NAME##_backward_backward<scalar_t>(  \
...
TORCH_LIBRARY_IMPL(torchscience, CPU, module) {                                 \
  ...
  module.impl(                                                                  \
    #OPERATOR_NAME "_backward",                                                 \
    &torchscience::cpu::NAMESPACE::OPERATOR_NAME##_backward                     \
  );                                                                            \
                                                                                \
  module.impl(                                                                  \
    #OPERATOR_NAME "_backward_backward",                                        \
    &torchscience::cpu::NAMESPACE::OPERATOR_NAME##_backward_backward            \
  );                                                                            \
}

#define CPU_BINARY_OPERATOR(                                                    \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2                                                                          \
...
#define CPU_QUATERNARY_OPERATOR(                                                \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
