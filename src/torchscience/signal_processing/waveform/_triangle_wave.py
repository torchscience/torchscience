...
def triangle_wave(
    ...
    *,
    ...
    Generates a triangle wave that rises linearly from -amplitude to +amplitude
    in the first half of each period, then falls linearly from +amplitude to
    -amplitude in the second half.
    ...
    result = torch.ops.torchscience.triangle_wave(
        n,
        t,
        frequency=frequency,
