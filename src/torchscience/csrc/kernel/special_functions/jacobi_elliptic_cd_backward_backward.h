...
#include "jacobi_elliptic_cd_backward.h"

namespace torchscience::kernel::special_functions {

// Second-order backward pass for Jacobi elliptic function cd(u, m)
//
// Uses numerical finite differences for second derivatives.
// Returns gradients w.r.t. (grad_output, u, m)

template <typename T>
C10_HOST_DEVICE std::tuple<T, T, T> jacobi_elliptic_cd_backward_backward(
    T grad_grad_u,
    T grad_grad_m,
    T gradient,
    T u,
    ...
    T f_center = jacobi_elliptic_cd(u, m);
    ...
    T f_u_plus_m_plus = jacobi_elliptic_cd(u + h, m + h);
    T f_u_plus_m_minus = jacobi_elliptic_cd(u + h, m - h);
    T f_u_minus_m_plus = jacobi_elliptic_cd(u - h, m + h);
    T f_u_minus_m_minus = jacobi_elliptic_cd(u - h, m - h);
...
jacobi_elliptic_cd_backward_backward(
    ...
    c10::complex<T> f_center = jacobi_elliptic_cd(u, m);
    ...
    // For mixed and second partials
    c10::complex<T> f_u_plus_m_plus = jacobi_elliptic_cd(u + h_complex, m + h_complex);
    c10::complex<T> f_u_plus_m_minus = jacobi_elliptic_cd(u + h_complex, m - h_complex);
    c10::complex<T> f_u_minus_m_plus = jacobi_elliptic_cd(u - h_complex, m + h_complex);
    c10::complex<T> f_u_minus_m_minus = jacobi_elliptic_cd(u - h_complex, m - h_complex);
