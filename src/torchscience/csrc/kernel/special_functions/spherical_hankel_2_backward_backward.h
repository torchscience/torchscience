...
#include "spherical_hankel_2_backward.h"

namespace torchscience::kernel::special_functions {

namespace detail {

// Second derivative w.r.t. z: d^2/dz^2 h_n^(2)(z)
// Using: d/dz[(n/z)*h_n - h_{n+1}]
//      = -n/z^2 * h_n + n/z * dh_n/dz - dh_{n+1}/dz
template <typename T>
C10_HOST_DEVICE c10::complex<T> spherical_hankel_2_zz_derivative(c10::complex<T> n, c10::complex<T> z) {
    const T eps = spherical_hankel_2_eps<T>();
    ...
    c10::complex<T> h_np2 = spherical_hankel_2(n + two, z);
...
// Mixed second derivative d^2/(dn dz) h_n^(2)(z) computed numerically
template <typename T>
C10_HOST_DEVICE c10::complex<T> spherical_hankel_2_nz_derivative(c10::complex<T> n, c10::complex<T> z) {
    ...
    c10::complex<T> h_p = spherical_hankel_2(n + h, z);
    c10::complex<T> h_p_p1 = spherical_hankel_2(n + h + one, z);
    c10::complex<T> dh_dz_plus = ((n + h) / z) * h_p - h_p_p1;

    c10::complex<T> h_m = spherical_hankel_2(n - h, z);
    c10::complex<T> h_m_p1 = spherical_hankel_2(n - h + one, z);
    c10::complex<T> dh_dz_minus = ((n - h) / z) * h_m - h_m_p1;

    return (dh_dz_plus - dh_dz_minus) / (two * h);
}

// Second derivative w.r.t. n: d^2/dn^2 h_n^(2)(z) computed numerically
template <typename T>
C10_HOST_DEVICE c10::complex<T> spherical_hankel_2_nn_derivative(c10::complex<T> n, c10::complex<T> z) {
    const T eps = std::cbrt(spherical_hankel_2_eps<T>());
    const c10::complex<T> two(T(2), T(0));
    ...
    c10::complex<T> h_center = spherical_hankel_2(n, z);
...
template <typename T>
C10_HOST_DEVICE std::tuple<c10::complex<T>, c10::complex<T>, c10::complex<T>> spherical_hankel_2_backward_backward(
    c10::complex<T> gg_n,
    c10::complex<T> gg_z,
    ...
    // Second derivatives
    c10::complex<T> d2h_dz2 = detail::spherical_hankel_2_zz_derivative(n, z);
    c10::complex<T> d2h_dn2 = detail::spherical_hankel_2_nn_derivative(n, z);
    c10::complex<T> d2h_dndz = detail::spherical_hankel_2_nz_derivative(n, z);
