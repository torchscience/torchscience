...
template <typename T>
C10_HOST_DEVICE std::tuple<T, T, T> polygamma_backward_backward(
...
template <typename T>
C10_HOST_DEVICE std::tuple<c10::complex<T>, c10::complex<T>, c10::complex<T>> polygamma_backward_backward(
