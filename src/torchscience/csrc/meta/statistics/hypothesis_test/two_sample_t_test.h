...
/**
 * Two-sample t-test meta implementation.
 *
 ...
 * @param equal_var Whether to assume equal variances (unused for shape inference)
...
TORCH_LIBRARY_IMPL(torchscience, Meta, m) {
    m.impl(
        "two_sample_t_test",
        &torchscience::meta::statistics::hypothesis_test::two_sample_t_test
    );
}
