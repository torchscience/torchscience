...
class TotalVariationDistance
    : public torch::autograd::Function<TotalVariationDistance> {
public:
    static at::Tensor forward(
        ...
        at::Tensor output = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::total_variation_distance", "")
            .typed<at::Tensor(
                const at::Tensor&,
                const at::Tensor&,
                int64_t,
    ...
    static torch::autograd::variable_list backward(
        ...
        auto [grad_p, grad_q] = c10::Dispatcher::singleton()
            .findSchemaOrThrow("torchscience::total_variation_distance_backward", "")
...
inline at::Tensor total_variation_distance(
    ...
    return TotalVariationDistance::apply(p, q, dim, input_type, reduction, pairwise);
}

}  // namespace torchscience::autograd::distance

TORCH_LIBRARY_IMPL(torchscience, Autograd, module) {
    module.impl("total_variation_distance", &torchscience::autograd::distance::total_variation_distance);
}
