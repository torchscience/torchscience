...
TORCH_LIBRARY_IMPL(torchscience, CPU, m) {
    m.impl("incomplete_beta", torchscience::cpu::incomplete_beta_forward);
    m.impl("incomplete_beta_backward", torchscience::cpu::incomplete_beta_backward);
    m.impl("incomplete_beta_backward_backward", torchscience::cpu::incomplete_beta_backward_backward);
}
