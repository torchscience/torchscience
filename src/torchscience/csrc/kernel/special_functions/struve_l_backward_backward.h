...
template <typename T>
C10_HOST_DEVICE T struve_l_zz_derivative(T n, T z) {
...
template <typename T>
C10_HOST_DEVICE T struve_l_nz_derivative(T n, T z) {
...
template <typename T>
C10_HOST_DEVICE T struve_l_nn_derivative(T n, T z) {
...
// Complex versions
template <typename T>
C10_HOST_DEVICE c10::complex<T> struve_l_zz_derivative(c10::complex<T> n, c10::complex<T> z) {
...
template <typename T>
C10_HOST_DEVICE c10::complex<T> struve_l_nz_derivative(c10::complex<T> n, c10::complex<T> z) {
    const T eps = std::sqrt(struve_l_eps<T>());
    const c10::complex<T> one(T(1), T(0));
    const c10::complex<T> two(T(2), T(0));
...
template <typename T>
C10_HOST_DEVICE c10::complex<T> struve_l_nn_derivative(c10::complex<T> n, c10::complex<T> z) {
    const T eps = std::cbrt(struve_l_eps<T>());
    const c10::complex<T> two(T(2), T(0));
...
template <typename T>
C10_HOST_DEVICE std::tuple<T, T, T> struve_l_backward_backward(
    T gg_n,
    T gg_z,
    T grad_output,
    T n,
...
// Complex version
template <typename T>
C10_HOST_DEVICE std::tuple<c10::complex<T>, c10::complex<T>, c10::complex<T>> struve_l_backward_backward(
    c10::complex<T> gg_n,
    c10::complex<T> gg_z,
