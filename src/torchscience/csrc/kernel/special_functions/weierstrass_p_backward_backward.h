...
#include "weierstrass_p.h"
#include "weierstrass_p_backward.h"

namespace torchscience::kernel::special_functions {

// Second-order backward pass for Weierstrass elliptic function P(z; g2, g3)
//
// Uses numerical finite differences for second derivatives.
// Returns gradients w.r.t. (grad_output, z, g2, g3)

template <typename T>
C10_HOST_DEVICE std::tuple<T, T, T, T> weierstrass_p_backward_backward(
    T grad_grad_z,
    T grad_grad_g2,
    T grad_grad_g3,
    T gradient,
    ...
    T h = detail::weierstrass_finite_diff_step<T>();

    // Compute function values at various points
    T f_center = weierstrass_p(z, g2, g3);
    T f_z_plus = weierstrass_p(z + h, g2, g3);
    T f_z_minus = weierstrass_p(z - h, g2, g3);
    T f_g2_plus = weierstrass_p(z, g2 + h, g3);
    T f_g2_minus = weierstrass_p(z, g2 - h, g3);
    T f_g3_plus = weierstrass_p(z, g2, g3 + h);
    T f_g3_minus = weierstrass_p(z, g2, g3 - h);

    // For mixed and second partials
    T f_z_plus_g2_plus = weierstrass_p(z + h, g2 + h, g3);
    T f_z_plus_g2_minus = weierstrass_p(z + h, g2 - h, g3);
    T f_z_minus_g2_plus = weierstrass_p(z - h, g2 + h, g3);
    T f_z_minus_g2_minus = weierstrass_p(z - h, g2 - h, g3);

    T f_z_plus_g3_plus = weierstrass_p(z + h, g2, g3 + h);
    T f_z_plus_g3_minus = weierstrass_p(z + h, g2, g3 - h);
    T f_z_minus_g3_plus = weierstrass_p(z - h, g2, g3 + h);
    T f_z_minus_g3_minus = weierstrass_p(z - h, g2, g3 - h);

    T f_g2_plus_g3_plus = weierstrass_p(z, g2 + h, g3 + h);
    T f_g2_plus_g3_minus = weierstrass_p(z, g2 + h, g3 - h);
    T f_g2_minus_g3_plus = weierstrass_p(z, g2 - h, g3 + h);
    T f_g2_minus_g3_minus = weierstrass_p(z, g2 - h, g3 - h);
...
weierstrass_p_backward_backward(
    ...
    c10::complex<T> f_center = weierstrass_p(z, g2, g3);
    c10::complex<T> f_z_plus = weierstrass_p(z + h_complex, g2, g3);
    c10::complex<T> f_z_minus = weierstrass_p(z - h_complex, g2, g3);
    c10::complex<T> f_g2_plus = weierstrass_p(z, g2 + h_complex, g3);
    c10::complex<T> f_g2_minus = weierstrass_p(z, g2 - h_complex, g3);
    c10::complex<T> f_g3_plus = weierstrass_p(z, g2, g3 + h_complex);
    c10::complex<T> f_g3_minus = weierstrass_p(z, g2, g3 - h_complex);

    // For mixed and second partials
    c10::complex<T> f_z_plus_g2_plus = weierstrass_p(z + h_complex, g2 + h_complex, g3);
    c10::complex<T> f_z_plus_g2_minus = weierstrass_p(z + h_complex, g2 - h_complex, g3);
    c10::complex<T> f_z_minus_g2_plus = weierstrass_p(z - h_complex, g2 + h_complex, g3);
    c10::complex<T> f_z_minus_g2_minus = weierstrass_p(z - h_complex, g2 - h_complex, g3);

    c10::complex<T> f_z_plus_g3_plus = weierstrass_p(z + h_complex, g2, g3 + h_complex);
    c10::complex<T> f_z_plus_g3_minus = weierstrass_p(z + h_complex, g2, g3 - h_complex);
    c10::complex<T> f_z_minus_g3_plus = weierstrass_p(z - h_complex, g2, g3 + h_complex);
    c10::complex<T> f_z_minus_g3_minus = weierstrass_p(z - h_complex, g2, g3 - h_complex);

    c10::complex<T> f_g2_plus_g3_plus = weierstrass_p(z, g2 + h_complex, g3 + h_complex);
    c10::complex<T> f_g2_plus_g3_minus = weierstrass_p(z, g2 + h_complex, g3 - h_complex);
    c10::complex<T> f_g2_minus_g3_plus = weierstrass_p(z, g2 - h_complex, g3 + h_complex);
    c10::complex<T> f_g2_minus_g3_minus = weierstrass_p(z, g2 - h_complex, g3 - h_complex);
