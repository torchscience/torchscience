...
template <typename T>
C10_HOST_DEVICE std::tuple<T, T> sin_pi_backward_backward(T gradient_gradient, T gradient, T x) {
...
template <typename T>
C10_HOST_DEVICE std::tuple<c10::complex<T>, c10::complex<T>> sin_pi_backward_backward(
