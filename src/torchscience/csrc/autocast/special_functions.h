...
#define TORCHSCIENCE_AUTOCAST_UNARY_OPERATOR(name, arg1)                       \
...
#define TORCHSCIENCE_AUTOCAST_BINARY_OPERATOR(name, arg1, arg2)                \
namespace torchscience::autocast::special_functions {                          \
                                                                               \
inline at::Tensor name(                                                        \
  const at::Tensor &(arg1),                                                    \
...
#define TORCHSCIENCE_AUTOCAST_TERNARY_OPERATOR(name, arg1, arg2, arg3)         \
namespace torchscience::autocast::special_functions {                          \
                                                                               \
inline at::Tensor name(                                                        \
  const at::Tensor &(arg1),                                                    \
...
#define TORCHSCIENCE_AUTOCAST_QUATERNARY_OPERATOR(name, arg1, arg2, arg3, arg4) \
namespace torchscience::autocast::special_functions {                          \
                                                                               \
inline at::Tensor name(                                                        \
  const at::Tensor &(arg1),                                                    \
...
TORCHSCIENCE_AUTOCAST_UNARY_OPERATOR(gamma, z)
TORCHSCIENCE_AUTOCAST_BINARY_OPERATOR(chebyshev_polynomial_t, x, n)
TORCHSCIENCE_AUTOCAST_TERNARY_OPERATOR(incomplete_beta, x, a, b)
