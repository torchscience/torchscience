...
#define TORCHSCIENCE_AUTOGRAD_BINARY_OPERATOR(name, Name, arg1, arg2)          \
namespace torchscience::autograd::special_functions {                          \
                                                                               \
class Name##Backward : public torch::autograd::Function<Name##Backward> {      \
public:                                                                        \
...
#define TORCHSCIENCE_AUTOGRAD_TERNARY_OPERATOR(name, Name, arg1, arg2, arg3)   \
namespace torchscience::autograd::special_functions {                          \
                                                                               \
class Name##Backward : public torch::autograd::Function<Name##Backward> {      \
public:                                                                        \
...
#define TORCHSCIENCE_AUTOGRAD_QUATERNARY_OPERATOR(name, Name, arg1, arg2, arg3, arg4) \
namespace torchscience::autograd::special_functions {                          \
                                                                               \
class Name##Backward : public torch::autograd::Function<Name##Backward> {      \
public:                                                                        \
...
TORCHSCIENCE_AUTOGRAD_UNARY_OPERATOR(gamma, Gamma, z)
TORCHSCIENCE_AUTOGRAD_BINARY_OPERATOR(chebyshev_polynomial_t, ChebyshevPolynomialT, x, n)
TORCHSCIENCE_AUTOGRAD_TERNARY_OPERATOR(incomplete_beta, IncompleteBeta, x, a, b)
TORCHSCIENCE_AUTOGRAD_QUATERNARY_OPERATOR(hypergeometric_2_f_1, Hypergeometric2F1, a, b, c, z)
