...
// Tolerance constants for spherical_hankel_2
template <typename T>
C10_HOST_DEVICE constexpr T spherical_hankel_2_eps();

template <>
C10_HOST_DEVICE constexpr float spherical_hankel_2_eps<float>() { return 1e-6f; }

template <>
C10_HOST_DEVICE constexpr double spherical_hankel_2_eps<double>() { return 1e-12; }

template <>
C10_HOST_DEVICE inline c10::Half spherical_hankel_2_eps<c10::Half>() { return c10::Half(1e-3f); }

template <>
C10_HOST_DEVICE inline c10::BFloat16 spherical_hankel_2_eps<c10::BFloat16>() { return c10::BFloat16(1e-3f); }
...
//
// Key properties:
// - h_n^(2)(z) represents incoming spherical waves
// - Singularity at z = 0
// - For large |z|: h_n^(2)(z) ~ (i)^{n+1} * e^{-iz} / z
// - h_n^(2)(z) = [h_n^(1)(z)]* for real z (complex conjugate)

// Complex n, complex z -> complex result
// This is the primary implementation
template <typename T>
C10_HOST_DEVICE c10::complex<T> spherical_hankel_2(c10::complex<T> n, c10::complex<T> z) {
