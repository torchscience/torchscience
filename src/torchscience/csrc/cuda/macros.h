...
#define TORCHSCIENCE_QUATERNARY_CUDA_KERNEL(SCHEMA_NAME, ARG0, ARG1, ARG2, ARG3) \
  at::Tensor SCHEMA_NAME##_forward_kernel(                                      \
    const at::Tensor& ARG0,                                                     \
    const at::Tensor& ARG1,                                                     \
    const at::Tensor& ARG2,                                                     \
          ...
          []GPU_LAMBDA(                                                         \
            ...
            return std::make_tuple(                                             \
              ...
              gradient * grad_##ARG3                                            \
                                                                                ...
                                                                                \
    return std::make_tuple(grad_##ARG0, grad_##ARG1, grad_##ARG2, grad_##ARG3); \
  }

#define TORCHSCIENCE_QUATERNARY_CUDA_KERNEL_IMPL(SCHEMA_NAME)                   \
  TORCH_LIBRARY_IMPL(                                                           \
    torchscience,                                                               \
    CUDA,                                                                       \
    module                                                                      \
