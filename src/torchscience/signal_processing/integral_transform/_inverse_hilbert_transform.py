...
def inverse_hilbert_transform(
    ...
    *,
    ...
    >>> x = torch.randn(100)
    >>> h = torchscience.signal_processing.integral_transform.hilbert_transform(x)
    >>> x_recovered = torchscience.signal_processing.integral_transform.inverse_hilbert_transform(h)
