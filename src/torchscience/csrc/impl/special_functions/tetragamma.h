...
C10_HOST_DEVICE C10_ALWAYS_INLINE scalar_t tetragamma(scalar_t x) {
  ...
  if constexpr (!c10::is_complex<scalar_t>::value) {
    if (x <= scalar_t(0)) {
      ...
      return tetragamma(scalar_t(1) - x) - scalar_t(2) * pi * pi * pi * cos_pi(x) / (sin_pi(x) * sin_pi(x) * sin_pi(x));
    }
  }
  ...
  output += -(scalar_t(1) / x * (scalar_t(1) / x)) - scalar_t(1) / x * (scalar_t(1) / x) * (scalar_t(1) / x) - scalar_t(1) / x * (scalar_t(1) / x) * (scalar_t(1) / x * (scalar_t(1) / x)) / scalar_t(2);

  return output + scalar_t(1) / x * (scalar_t(1) / x) * (scalar_t(1) / x * (scalar_t(1) / x)) * ( scalar_t(3.0 * tetragamma_detail::B2) + scalar_t(1) / x * (scalar_t(1) / x) * ( scalar_t(5.0 * tetragamma_detail::B4) + scalar_t(1) / x * (scalar_t(1) / x) * ( scalar_t(7.0 * tetragamma_detail::B6) + scalar_t(1) / x * (scalar_t(1) / x) * ( scalar_t(9.0 * tetragamma_detail::B8) + scalar_t(1) / x * (scalar_t(1) / x) * scalar_t(11.0 * tetragamma_detail::B10)))));
}
...
C10_HOST_DEVICE C10_ALWAYS_INLINE c10::complex<T> tetragamma(c10::complex<T> x) {
  ...
  while (x.real() < T(7)) {
    output = output - c10::complex<T>(2, 0) / (x * x * x);
    x = x + c10::complex<T>(1, 0);
  }

  return output - c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) - c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * (c10::complex<T>(1, 0) / x) - c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * (c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x)) / c10::complex<T>(2, 0) + c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * (c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x)) * ( c10::complex<T>(T(3.0 * tetragamma_detail::B2), 0) + c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * ( c10::complex<T>(T(5.0 * tetragamma_detail::B4), 0) + c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * ( c10::complex<T>(T(7.0 * tetragamma_detail::B6), 0) + c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * ( c10::complex<T>(T(9.0 * tetragamma_detail::B8), 0) + c10::complex<T>(1, 0) / x * (c10::complex<T>(1, 0) / x) * c10::complex<T>(T(11.0 * tetragamma_detail::B10), 0) ) ) ) );
}
