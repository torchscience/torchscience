...
namespace torchscience::quantized::cpu::special_functions {
  ...
  /**
 * Quantized CPU implementation for chebyshev_polynomial_t.
 *
 * This implementation dequantizes inputs to floating-point, computes the
 * Chebyshev polynomial using the standard floating-point implementation,
 * and requantizes the result.
 *
 * QUANTIZATION BEHAVIOR:
 *   - Input tensors are dequantized using their stored scale and zero_point
 *   - Computation is performed in floating-point (typically float32)
