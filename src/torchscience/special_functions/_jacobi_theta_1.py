...
__all__ = ["jacobi_theta_1"]


def jacobi_theta_1(z: Tensor, q: Tensor) -> Tensor:
    r"""
    Jacobi theta function :math:`\theta_1(z, q)`.
    ...
    """
    return torchscience.ops.torchscience._jacobi_theta_1(z, q)
