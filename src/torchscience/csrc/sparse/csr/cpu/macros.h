...
#define SPARSE_CSR_CPU_UNARY_OPERATOR(                                          \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1                                                                          \
)                                                                               \
...
TORCH_LIBRARY_IMPL(torchscience, SparseCsrCPU, module) {                        \
  ...
  module.impl(                                                                  \
    ...
    &torchscience::sparse::csr::cpu::NAMESPACE::OPERATOR_NAME##_backward        \
  );                                                                            \
                                                                                \
  module.impl(                                                                  \
    #OPERATOR_NAME "_backward_backward",                                        \
    &torchscience::sparse::csr::cpu::NAMESPACE::OPERATOR_NAME##_backward_backward\
  );                                                                            \
}

#define SPARSE_CSR_CPU_BINARY_OPERATOR(                                         \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2                                                                          \
...
#define SPARSE_CSR_CPU_TERNARY_OPERATOR(                                        \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
...
#define SPARSE_CSR_CPU_QUATERNARY_OPERATOR(                                     \
  NAMESPACE,                                                                    \
  OPERATOR_NAME,                                                                \
  ARG1,                                                                         \
  ARG2,                                                                         \
