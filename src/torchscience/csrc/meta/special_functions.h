...
#define TORCHSCIENCE_META_UNARY_OPERATOR(name, arg1)                           \
...
#define TORCHSCIENCE_META_BINARY_OPERATOR(name, arg1, arg2)                    \
namespace torchscience::meta::special_functions {                              \
                                                                               \
inline at::Tensor name(                                                        \
  const at::Tensor &arg1##_input,                                              \
...
#define TORCHSCIENCE_META_TERNARY_OPERATOR(name, arg1, arg2, arg3)             \
namespace torchscience::meta::special_functions {                              \
                                                                               \
inline at::Tensor name(                                                        \
  const at::Tensor &arg1##_input,                                              \
...
#define TORCHSCIENCE_META_QUATERNARY_OPERATOR(name, arg1, arg2, arg3, arg4)    \
namespace torchscience::meta::special_functions {                              \
                                                                               \
inline at::Tensor name(                                                        \
  const at::Tensor &arg1##_input,                                              \
...
TORCHSCIENCE_META_UNARY_OPERATOR(gamma, z)
TORCHSCIENCE_META_BINARY_OPERATOR(chebyshev_polynomial_t, x, n)
TORCHSCIENCE_META_TERNARY_OPERATOR(incomplete_beta, x, a, b)
TORCHSCIENCE_META_QUATERNARY_OPERATOR(hypergeometric_2_f_1, a, b, c, z)
