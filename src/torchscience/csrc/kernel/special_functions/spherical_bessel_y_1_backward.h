...
template <typename T>
C10_HOST_DEVICE T spherical_bessel_y_1_backward(T grad_output, T z) {
...
// Complex version
template <typename T>
C10_HOST_DEVICE c10::complex<T> spherical_bessel_y_1_backward(c10::complex<T> grad_output, c10::complex<T> z) {
