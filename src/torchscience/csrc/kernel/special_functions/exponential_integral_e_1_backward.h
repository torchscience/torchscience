...
template <typename T>
C10_HOST_DEVICE T exponential_integral_e_1_backward(T gradient, T x) {
...
template <typename T>
C10_HOST_DEVICE c10::complex<T> exponential_integral_e_1_backward(c10::complex<T> gradient, c10::complex<T> z) {
